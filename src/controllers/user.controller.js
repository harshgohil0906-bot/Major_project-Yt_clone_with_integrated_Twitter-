...
const updateAccountDetails = asyncHandler(async(req, res) => {
    ...
    const user = await User.findByIdAndUpdate(//findByIdAndUpdate is inbuilt method
        req.user?._id,
        {
            $set: {
                fullname,
...
const getUserChannelProfile = asyncHandler(async(req, res) => {
    ...
    const channel = await User.aggregate([
        ...
        {
            $project: { // means which data do u wanna to give frontend
                fullname: 1,
                username: 1,
                subscribersCount: 1,
